          ...
          <div class="book-infos">
            <div class="book-base-info">
              ...
              <div class="info">
                ...
                <iv-tag type="border" v-for="tag in bool.tagList" :key="tag.name" class="border-tag">{{tag.name}}</iv-tag>
              </div>
            ...
            <vue-tabs class="book-detail-info">
              ...
              <v-tab :title="'读后感'">
                <div class="article-details" id="article-main-page" ref="book" v-if="book.bookSense">
                  <div class="detail">
                    <aritcle class="typo container article-main-content" v-html="book.bookSense.content"></aritcle>
