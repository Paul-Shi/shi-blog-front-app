<template>
  <div class="simple-header">
    ...
    <transition name="slide-fade">
      <div id="header" v-show="show"></div>
      <router-link id="logo" to="/">
        <img src="../../../assets/logo.png">
        <span class="title">Yuan's Blog</span>
          ...
          <form id="search-form" action="/articles/search">
              <span class="algolia-autocomplete" style="position: relative; display: inline-block; direction: ltr;">
                <input type="text" id="search-query-nav" class="search-query st-default-search-input aa-input"
                       name="keywords" v-model="keywords" @keyup.enter="submit"
    ...
    <sidebar ref="sidebar" :articleCategoryList="artilceCategoryList" :bookCategoryList="bookCategoryList"></sidebar>
  </div>
</template>
